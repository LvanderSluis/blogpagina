...
include('../includes/registreren.inc.php')
  ...
  <body>
    ...
    <header id="header">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1 class="text-center"><small>Registreren</small></h1>
          </div>
        </div>
      </div>
    </header>
          ...
          <div class="col-md-4 col-md-offset-4">
            <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" enctype="multipart/form-data">
             ...
             ?>
              <div class="form-group">
                <label>Naam</label>
                <input type="text" name="name" class="form-control" placeholder="Uw naam" value="<?php echo $name ?>">
              ...
              <div class="form-group">
                ...
                <textarea rows="4" name="about" cols="50" class="form-control" placeholder="Vertel in het kort iets over uzelf" value="over mijzelf"></textarea>
              </div>
              <div class="form-group">
